...
public class Main {
    ...
    public static final String CONTACT_REPEATED = "There are contacts that share phone numbers.";
    public static final String CONTACT_ALL_DIFFERENT = "All contacts have different phone numbers.";
    ...
    private static void repeatedPhone(ContactBook cBook) {
        if (cBook.hasRepeated()) System.out.println(CONTACT_REPEATED);
        else System.out.println(CONTACT_ALL_DIFFERENT);
    }
}
